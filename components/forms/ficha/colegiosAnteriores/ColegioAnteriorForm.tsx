      ...
      <div className="overflow-x-auto rounded-lg border border-border">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-slate-100">
            {data.map((fila) => (
              <tr key={fila._tempId} className="bg-background hover:bg-muted/50/50 transition-colors">
                ...
                <td className="px-3 py-2">
                  <input
                    ...
                    className="w-full min-w-[180px] rounded border border-border px-2 py-1.5 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50"
                  />
                </td>
                ...
                <td className="px-3 py-2">
                  <input
                    ...
                    className="w-full min-w-[130px] rounded border border-border px-2 py-1.5 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50"
                  />
                </td>
                ...
                <td className="px-3 py-2">
                  <input
                    ...
                    placeholder="Ej: 5°"
                    className="w-full min-w-[100px] rounded border border-border px-2 py-1.5 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50"
                  />
                </td>
                ...
                <td className="px-3 py-2">
                  <input
                    ...
                    className="w-full min-w-[80px] rounded border border-border px-2 py-1.5 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50"
                  />
                </td>
                ...
                <td className="px-3 py-2 text-center">
                  <button
                    ...
                    title="Eliminar fila"
                    className="text-muted-foreground/50 hover:text-red-400 transition-colors p-1 rounded disabled:opacity-50"
                  >
